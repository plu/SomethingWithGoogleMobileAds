 ...
 * @param options GANSearchAdControllerOptions, such as adTest, and adSafe,
                  etc.
...
/**
 * Populate an adView with the ad specified by the identifier and call the completion handler when
 ...
 *                     unique string will be assigned to the next available ad until ads are
 *                     exhausted.
 * @param completionHandler The completion handler to be called when the ad view is ready to be
 * displayed. Ad specific data will provided such as the height of the ad view.
 */
